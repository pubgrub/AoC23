...
inputLines.forEach((l, lIdx) => {
    var _a;
    if (l.length !== 0) {
        (_a = grids.at(-1)) === null || _a === void 0 ? void 0 : _a.push(l);
    }
    else {
...
// **********************************************
function getArraysFromGrid(grid) {
    const rowSum = [];
    const colSum = [];
...
function findAlteredMirrorLine(grid, part1Val) {
...
function findMirrorLine(arrays, part1Val) {
    const factor = [1, 100];
