...
const rotOrigStringGrid = [JSON.parse(JSON.stringify(inputLines))];
const rotHashGrid = [hashGrid(rotOrigStringGrid[0])];
...
function doLineRoll(sourceLine, destLine, destHashLine) {
...
function rockGrid(grid) {
    const rockList = grid.reduce((rList, s, sIdx, g) => {
