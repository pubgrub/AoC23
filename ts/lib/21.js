...
function solve(p, step, maxStep_) {
    if (maxStep_ < 0)
        return 0;
    seen[p * 1000 + step] = 1;
    if (step === maxStep_) {
...
function solve2Rec(p, step, maxStep_) {
    if (maxStep_ < 0)
        return 0;
    seen[p * 1000 + step] = 1;
    if (step === maxStep_) {
...
function coloredGrid(grid, width, mode) {
